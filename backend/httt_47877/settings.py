"""
Django settings for httt_47877 project.
...
WSGI_APPLICATION = 'httt_47877.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "httt_47877 API",
    "DESCRIPTION": "API documentation for httt_47877 App",
    "VERSION": "v1",
}
